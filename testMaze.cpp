...
TEST_CASE("treasureMap::basic no cycles", "[weight=1][part=treasureMap]")
{
    ...
    treasure.writeToFile("images/test2.png");
    PNG treasuremazeans;
    ...
    solnmaze.writeToFile("images/testdecoderRenderMaze.png");
    PNG solnmazeans;
    ...
    soln.writeToFile("images/testRenderSolution.D-case1.png");
    PNG solnans;
...
TEST_CASE("decoder::basic cycles", "[weight=1][part=decoder]")
{
    ...
    treasure.writeToFile("images/testRenderMap.M-case2.png");
    PNG treasureans;
    ...
    treasuremaze.writeToFile("images/testRenderMaze.M-case2.png");
    PNG treasuremazeans;
    ...
    solnmaze.writeToFile("images/testRenderMaze.D-case2.png");
    PNG solnmazeans;
    ...
    soln.writeToFile("images/testRenderSolution.D-case2.png");
    PNG solnans;
